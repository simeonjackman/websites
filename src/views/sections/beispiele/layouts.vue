...
<template>
  ...
  >
    ...
    <template #exercise>
      <p>
        Baue ein Seitenlayout mit einer Kopfzeile, einem Inhaltsbereich und
        einer Seitenleiste. Starte mit einer Spalte und erweitere es erst für
